...
class Container_db30e06faf extends _PHPStan_8c66d8255\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_db30e06faf $container)
			{
	...
	public function createServiceContainer(): Container_db30e06faf
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'paths' => [
				...
				'C:\laragon\www\baseforfight\routes',
